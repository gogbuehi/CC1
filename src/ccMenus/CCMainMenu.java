...
public class CCMainMenu extends JMenuBar {
    ...
    public void makeMenus() {
        ...
        String [] rActns = {"VBS","VBSH","VBH","VBHSA","VBA","VBHOL","VBHUL","VBHU","VBHI","VBHB","VBHEMAILIN","VBHCEMAIL","VBHCNAME","VBHCPDMSM","VBHEMAILLINK","VBHWEBLINK"};
        String [] rItems = {"VB-String","VB-String + HTML","VB-HTML","VB-String Array","VB-Array","Ordered List \"<ol>\"","Unordered List \"<ul>\"","Underline \"<u>\"","Italics \"<i>\"","Bold \"<b>\"","Email Input","Contact Email","Contact Name","Contact PD/MSM","Email Link","Web Link"};
        String hHead = "Help";
